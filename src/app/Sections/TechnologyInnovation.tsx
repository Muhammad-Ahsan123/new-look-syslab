...
function TechnologyInnovation() {
    return (
        <>
            <div id='about' className='relative h-[40rem] sm:h-[35rem]'>
                <div className='absolute w-full px-12 sm:px-40 md:px-0 h-[40rem] sm:h-[35rem] bg-[#04060A] opacity-[0.88]'>
                </div>
                <div className='absolute flex-col sm:flex-row items-center justify-evenly flex sm:justify-between px-6 sm:px-8 lg:px-40  md:px-16 xl-px-40  h-[40rem] sm:h-[35rem] sm:items-center text-white text-center sm:text-left'>
                    <div className='sm:w-[70%] md:w-[50%] w-full mt-4 sm:mt-0'>
                        <h2 className='text-3xl font-bold mb-6'>Technology Meets
                            <span className="md:mt-2 mt-2 px-10 inline-block -rotate-3 rounded-full py-2 border ml-2"
                            // style={{ marginTop: window.innerWidth <= 680 ? "10px" : "0px" }}
                            >
                        ...
                        <p>Our team is dedicated to advancing innovation through groundbreaking research and development across a variety of emerging technologies. From artificial intelligence to sustainable solutions, we are constantly pushing the boundaries of discovery. Highlighted here are some of our leading research publications, showcasing the impact and depth of our work in shaping the future.</p>
                    </div>
