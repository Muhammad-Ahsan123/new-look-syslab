...
//     return (
//         <>
//             <div id="home" className="relative overflow-hidden border-10 h-screen md:h-[100vh] flex justify-center sm:items-center">
//                 <video src="/mainbannervideo.mp4" autoPlay loop muted playsInline preload="auto" className="absolute w-full h-screen md:h-[100vh] bg-no-repeat opacity-[0.88] object-cover" poster="/video-placeholder.jpg"></video>
...
//                             {/* <h2 className="text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300 font-bold h-[55px] md:h-[84px]">
//                                 Syslab.ai
//                             </h2> */}
...
//                 <div className="w-full rounded-md relative flex flex-col items-start sm:items-center justify-center antialiased overflow-hidden">
//                     <div className="flex flex-col gap-4 lg:flex-row items-center justify-evenly lg:h-screen z-10">
//                         {/* Left Side Content */}
//                         <div className="w-[83%] md:w-[60%] lg:w-[40%] ">
//                             <h2 className="text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-t from-gray-400 to-neutral-100 font-bold h-[55px] md:h-[84px]">
//                                 Syslab.ai
//                             </h2>
//                             <h2 className="text-xl sm:text-2xl font-semibold inline-block py-1 text-white">
